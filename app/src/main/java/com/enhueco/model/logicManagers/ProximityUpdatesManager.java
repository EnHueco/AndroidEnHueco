...
import com.enhueco.view.MainTabbedActivity;
...
public class ProximityUpdatesManager implements Serializable
{
    ...
    public void reportVisibleBestSignalAccessPointAndNewAccessPointsIfNecessary()
    {
        ...
        ConnectionManagerArrayRequest request = new ConnectionManagerArrayRequest(EHURLS.BASE, HTTPMethod.POST, Optional.<String>absent());
